 ...
 */
final class Version20221101083907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, intro TEXT DEFAULT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, cover VARCHAR(255) NOT NULL, is_published BOOLEAN NOT NULL, PRIMARY KEY(id))');
